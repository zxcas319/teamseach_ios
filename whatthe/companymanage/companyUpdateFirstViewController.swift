//
//  companyUpdateFirstViewController.swift
//  whatthe
//
//  Created by donggyukim on 27/02/2019.
...
class companyUpdateFirstViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let dest = segue.destination as! companyUpdateDetailViewController
        dest.company = deleteCompany
        dest.up_company = dropDownItem
    }
